...
## Project and Character Notice

This is an independent project by individual developers, currently intended for non-commercial learning, personal demonstrations, and technical exchange. It is not an official project of Beijing Jiaotong University, Hypergryph, or the rights holders of *Arknights*, has no official partnership with them, and has not been officially authorized or endorsed by them.

The project uses the name and persona of Amiya from *Arknights* as a fan-created interaction example. Rights in the original character, setting, trademarks, artwork, dialogue, and audio remain with their respective rights holders. Responses are generated by AI models and do not represent official character dialogue or the views of the original creators.

The MIT license applies to original code and documentation that the contributors have the right to license. It does not grant any rights to third-party characters, trademarks, or other protected material. Third-party dependencies remain subject to their own licenses. The project's current non-commercial purpose does not impose a non-commercial restriction on code licensed under MIT.

This notice explains the project's nature and the scope of its license; it does not constitute permission from third-party rights holders. Anyone reusing or distributing the project must independently assess the rights and permissions required for their use of third-party material.

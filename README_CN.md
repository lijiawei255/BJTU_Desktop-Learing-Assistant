...
本项目由个人开发者独立开发，目前用于非营利的学习、个人展示与技术交流。本项目不是北京交通大学、鹰角网络或《明日方舟》相关权利人的官方项目，与上述主体不存在官方合作关系，亦未获得其官方授权、认可或背书。

本项目使用《明日方舟》中“阿米娅（Amiya）”的名称与人格设定，作为爱好者创作的交互示例。原作角色、世界观、商标、美术、台词及音频等内容的相关权利归各自权利人所有。本项目的 AI 回复由模型生成，不代表官方角色台词或原作者立场。

MIT 许可证适用于贡献者有权授权的原创代码及原创文档，不授予任何第三方角色、商标或其他受保护内容的权利。第三方依赖适用各自的许可证。本项目目前的非营利用途说明，不构成对 MIT 许可代码的非商业使用限制。

本声明用于说明项目性质与许可范围，不构成第三方权利人的授权。复用或分发本项目时，使用者应根据实际用途，另行核查涉及第三方内容所需的权利与许可。
